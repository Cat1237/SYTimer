...
namespace SY {
    ...
    public:
        ...
        constexpr double minutes() const { return _value / 60; }
        constexpr double seconds() const { return _value; }
        ...
        __attribute__((visibility("default"))) WallTime operator+(WallTime) const;
        __attribute__((visibility("default"))) MonotonicTime operator+(MonotonicTime) const;
    ...
    __attribute__((visibility("default"))) void sleep(Seconds);
...
namespace std {
    ...
    inline bool isnan(SY::Seconds seconds)
    {
        return std::isnan(seconds.value());
    }
    
    inline bool isinf(SY::Seconds seconds)
    {
        return std::isinf(seconds.value());
    }
    
    inline bool isfinite(SY::Seconds seconds)
    {
...
using namespace SY::seconds_literals;
using SY::Seconds;
